	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			if ( true !== $this->is_tgmpa_complete() ) {
				 ...
				 * @since theme 17.04.2019 > theme refactor
				 */
		...
		public function does_plugin_have_update( $slug ) {
			...
			if ( 'repo' !== $this->plugins[ $slug ]['source_type'] ) {
				...
				if ( class_exists( 'tagdiv_theme_plugins_setup', false ) ) {
					$instance = tagdiv_theme_plugins_setup::get_instance();
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		public function no_items() {
			echo esc_html__( 'No plugins to install, update or activate.', 'tgmpa' ) . ' <a href="' . esc_url('admin.php?page=td_theme_plugins') . '"> ' . esc_html( $this->tgmpa->strings['return'] ) . '</a>';
			echo '<style type="text/css">#adminmenu .wp-submenu li.current { display: none !important; }</style>';
		}
